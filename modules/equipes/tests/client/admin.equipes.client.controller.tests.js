(function () {
  ...
  describe('Equipes Admin Controller Tests', function () {
    // Initialize global variables
    var EquipesAdminController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _EquipesService_, _Notification_) {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (EquipesService) {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Equipe saved successfully!' });
        // Test URL redirection after the equipe was created
        expect($state.go).toHaveBeenCalledWith('admin.equipes.list');
      }));
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Equipe save error!' });
      });
    });
    ...
    describe('vm.save() as update', function () {
      ...
      it('should  call Notification.error if error', inject(function (EquipesService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the equipe and redirect to equipes', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Equipe deleted successfully!' });
        expect($state.go).toHaveBeenCalledWith('admin.equipes.list');
      });
